            ...
            <div class="col-lg-10 offset-1">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="image">
                                        <a href="#">
                                            ...
                                            @if (Auth::user()->gender=='male')
                                                <img src="{{asset('image/default-male-image.png')}}" class="w-100">
                                            @else
                                                <img src="{{asset('image/default-female-image.webp')}}" class="w-100">
                                            @endif
                                            @else
                        ...
                        <div class="row">
                            <div class=" offset-2">
                                <a href="{{route('user#editProfilePage')}}" class=" btn btn-primary"><i class="fa-solid fa-pen-to-square"></i>Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
